...
[Command]
name = "cola atack2"
command = D, DF, F, x ;para completa aperte x,x
time = 15
[Command]
name = "cola atack3" ;para continua faça lazer duplo  D, DB, B, y  power =200
command = D, DB, B, y
time = 15
[Command]
name = "lazer duplo"
...
time = 15
[Command]
name = "cola atack6"   ;para completa aperte a no 4 hit
command = D, DB, B, a
time = 15
[Command]
name = "cola atack7"
...
type = ChangeState
value = 2000
triggerall = command = "tiro mortal"
...
type = ChangeState
value = 2400
triggerall = command = "raios pelos olhos"
...
type = ChangeState
value = 2200
triggerall = command = "atack multiplos"
...
type = ChangeState
value = 2500
triggerall = command = "5 forma atack"
...
type = ChangeState
value = 2300
triggerall = command = "bola mortal"
...
type = ChangeState
value = 3100
triggerall = command = "cola atack2"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
[State -1]
type = ChangeState
value = 3200
triggerall = command = "cola atack3"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
trigger3= stateno = 1500
...
type = ChangeState
value = 3300
triggerall = command = "cola atack4"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
[State -1]
type = ChangeState
value = 3400
triggerall = command = "cola atack5"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
[State -1]
type = ChangeState
value = 3500
triggerall = command = "cola atack6"
triggerall = power >5
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
...
type = ChangeState
value = 3600
triggerall = command = "cola atack7"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
trigger3 = stateno = 1500
...
type = ChangeState
value = 3700
triggerall = command = "cola atack8"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
[State -1]
