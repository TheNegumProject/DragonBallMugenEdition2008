...
type 			= changestate
value 		= 3000
triggerall 		= (command = "ki ball") && (power >= 1000)
...
type 			= changestate
value 		= 3010
triggerall 		= (command = "ki wave") && (power >= 2000)
trigger1		= ((statetype = s) && (ctrl)) || (var(3) > 0)
...
type			= changestate
value		= 3500
;triggerall		= var(53) = 0 ; enable this to make this hyper only once per round
;triggerall		= life <= 500 ;
triggerall		= command = "deep impact" && (power >= 3000)
trigger1		= ((statetype = s) && (ctrl)) || (var(3) > 0)
...
type 			= changestate
value 		= 1000
triggerall 		= (command = "slap attack")
trigger1		= ((statetype = s) && (ctrl)) || (var(3) = 1)

;---------------------------------------------------------------------------
;flying butt attack
[state -1: 		flying butt attack]
type 			= changestate
value 		= 1010
triggerall 		= (command = "flying butt attack")
trigger1		= ((statetype = s) && (ctrl)) || (var(3) = 1)
...
type 			= changestate
value 		= 1030
triggerall 		= (command = "triangle kick")
