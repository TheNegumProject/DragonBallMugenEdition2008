...
Funimation, or Bandai. I did not create the sounds or effects, so please don't steal
them. If you wish to see which effects, sprites, and code segments you can get for free
please look at my Permissions.txt found on my website(link below).
...
***Best viewed at Size -10- -Lucida Console- -Regualar- Fonts(with |Word Wrap| enabled)....*** 
           ...
           <Creator: Chrono_Strife>
            Version: 12.25.06/3.2 release patch/320%(it's a real percent! >.>)
...
-Color: A:White, Black         Command: Start+a        Difficulty: 1.0         #07
-Color: A:Green, Yellow        Command: Start+b        Difficulty: 1.0         #08
-Color: A:SSj(Orange, Blue)    Command: Start+c        Difficulty: 1.0         #09
-Color: S:Black, White         Command: Start+x        Difficulty: 1.0         #10
-Color: S:Brown, Brown         Command: Start+y        Difficulty: 1.0         #11
-Color: S:SSj3(Gold,Blue)      Command: Start+z        Difficulty: 1.0         #12
...
; Super Jump
command = D, U or UF or UB(or KKK)
power = 0
damage = N/A               
combo = N/A
...
-Fixed the ReadMe a bit.
			           ...
			           - August 15, 2006-
Version 3.1 Patch:
-Changed the afterimage effect on the Souki-dan.
-If Souki-Dan is attacked too close, the explosion will deal damage.
-Added KKK command to Super Jump.
-Super Jump is chainable through Launcher Kick.

			          - December 25, 2006-
Version 3.2 Patch:
-Ryuken(Wolf Slash) can be done while jumping now.
-4 new pallettes, SSj pallette looks moved to s+z || s+z buttons.
-Wolf Fang Fist deals 20 more damage.
-Getting hit by the Souki-Dan's explosion results in 75 damage now(Safer to black at close range now *hint hint*).
-Amazing update to Yamcha's Character Information seen below. The truth behind Yamcha and his !son!



                                 - Possible Future Plans -
-1: Bug fixes, possibly change hit sounds.
-2: Quit MUGEN.
...
_4. Information
  ...
  Character: Yamcha begins in Dragon Ball as a theif. He stole Capsules from wanderers who 
	     ...
	     Some time later, after Buu is killed Yamcha and Bulma's aborted son Pants appears. 
           The aborted fetus was rescued by the good Doctor Gero in the ancient Dragon Ball days 
           put in a super secret lab, under the super secret lab containing Cell, which was located 
           under the Super Secret lab which housed #16, #17,and #18. Pants was Dr. Gero's greatest 
           achievment, and he should be. The original sprite was to resemble a black haired version 
           of sexy Chrono_Strife. Pants however is a troubled young man, seeking revenge on the two 
           parents who screwed him over(or tried too). Pants successfully beat all the Z-Fighters 
           however was beat by Yamcha himself, and later spanked by Bulma for being a naughty boy. 
           After his defeat Pants went on to become Chrono_Strife, Mugen legend. Who can now be 
           spotted from time to time having lots of sex, and eating General Tso's Chicken(fantastic 
           Chinese Dish which just gives the mouth orgasms, if you've tried it you know what I mean).
             Pants and Trunks are ideal rivals, both wielding swords, both children of Bulma. Pants 
           wins by default though. Just look at Trunks, lilac colored hair, imagine someone walking
           down the street with that hair. That's an automatic fail, unless Chrono_Strife does it(and
           he has).
             The moral of the story is don't have abortions and if you do please do it right. Imagine 
           a world with more than one Chrono_Strife... All the hot women are taken, lots of bukkake 
           related drownings, and alot more crap that makes no sense at all. On the bright side
           Calculus would be banned from schools, and there would be alot more pretty people. I mean
           let's admit it, I'm dead sexy. I know it, my girlfriend knows it, you know it, plus my
           my mom said I'm special. So it must be true... XD

  Importance:Yamcha has had long lasting effects on the Z-group as well even after he quits 
           fighting. For example Gohan shares similar hairsyles, probably copied them since Yamcha 
           always looked so damn hot(my opinion proven by the fact Bulma believed he was cheating 
           on her, not that she had any room to talk, since she slept with an ugly short guy with 
           a hemeroid problem).
...
_Super Butouden           _Android 18 0.1a(Sexual Fantasy)5.0           -Cyanide and Neocide    -Kid Buu
_Super Butouden		  _ICell                          5.9           -Tenma-chan & Yakumo    -Karima Kenji
