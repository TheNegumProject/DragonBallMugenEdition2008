...
[Command]
name = "super combo"
command = D, DB, B, F, b ;complete com   x,x,a,a,y,y,b,b esta em random
time = 30
[Command]
name = "genki dama"
command = D, DB, B, F, z
...
time = 30
[Command]
name = "goku senpukyaku"
command = D, DB, B, c
time = 15
[Command]
name = "snes chutes"
command = D, DB, B, b ;precione b,b na hora do hit
time = 15
[Command]
name = "3chutes subindo"
command = D, DB, B, a ;precione a,a para completa
time = 15
[Command]
name = "Tayoken"
command = D, DB, B, x
...
time = 15
[Command]
name = "rasgao aereo"  ; feito no alto
command = D, DF, F, a
time = 15
[Command]
name = "rasgao aereo2" ;feito no alto
command = D, DF, F, b
time = 15
[Command]
name = "rasgao aereo3"  ;feito no alto com kayoken
command = D, DF, F, c
time = 15
[Command]
name = "kienzan"
...
time = 15
[Command]
name = "socos saiyjin" ;precione x,x,x,x para completa
command = D, DF, F, x
time = 15
[Command]
name = "chutes saiyjin" ;precione c,c,c,c,c para completa
command = D, DF, F, c
time = 15
[Command]
name = "combo kaio"
...
time = 15
[Command]
name = "lendario ssj goku" ; so pode ser feito 1 vez em cada round
command = D, DF, F, x+y
time = 30
[Command]
name = "velocidade"
...
value = 8100
triggerall = Var(58) = 0
triggerall = command = "lendario ssj goku"
...
type = ChangeState
value = 174001
triggerall = command = "kamehameha kayoken"
...
type = ChangeState
value = 7300
triggerall = command = "kayoken 20x"
triggerall = power >= 2000
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2  = stateno = [200,400]
...
type = ChangeState
value = 7500
triggerall = command = "goku senpukyaku"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2  = stateno = [200,400]
trigger2  = (movecontact)
...
type = ChangeState
value = 7501
triggerall = command = "snes chutes"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2  = stateno = [200,400]
trigger2  = (movecontact)
...
type = ChangeState
value = 7502
triggerall = command = "3chutes subindo"
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2  = stateno = [200,400]
trigger2  = (movecontact)
...
type = ChangeState
value = 7700
triggerall = command = "socos saiyjin"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
trigger3= stateno = 1500
...
type = ChangeState
value = 7800
triggerall = command = "chutes saiyjin"
trigger1 = (statetype = S) && (ctrl = 1)
trigger2 = stateno = [200,300]
trigger2 = MoveContact
trigger3= stateno = 1500
...
type = ChangeState
value = 789991
triggerall = command = "magia no alto"
...
type = ChangeState
value = 8000
triggerall = command = "rasgao aereo"
...
type = ChangeState
value = 8001
triggerall = command = "rasgao aereo2"
trigger1 = StateType = A && ctrl
trigger2 = stateno = [600,650]
trigger2 = MoveContact
[State -1]
type = ChangeState
value = 8002
triggerall = command = "rasgao aereo3"
trigger1 = StateType = A && ctrl
trigger2 = stateno = [600,650]
trigger2 = MoveContact
[State -1]
